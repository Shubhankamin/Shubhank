...
.contact-button {
  background: rgba(211, 245, 118, 0.95);
  ...
  box-shadow: 0 10px 30px rgba(211, 245, 118, 0.12);
}
...
.contact-button:hover {
  ...
  box-shadow: 0 15px 40px rgba(211, 245, 118, 0.2);
}
...
.icon:hover {
  ...
  background: rgba(211, 245, 118, 0.12);
